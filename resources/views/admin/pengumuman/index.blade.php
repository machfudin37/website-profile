...
@section('konten')
    <main class="main users chart-page" id="skip-target">
        <div class="container">
            <h2 class="main-title">Pengumuman</h2>
            <a class="btn btn-primary" href="{{ route('admin.pengumuman.tambah') }}">Tambah</a><br><br>
            <div class="messages">
                                                        ...
                                                        <td>
                                                            <span class="p-relative">
                                                                ...
                                                                <ul class="users-item-dropdown dropdown">
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('admin.pengumuman.edit', ['id' => $p->id]) }}"
                                                                            method="get">
                                                                            @csrf
                                                                            <button type="submit"
                                                                    ...
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('admin.pengumuman.hapus', ['id' => $p->id]) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('DELETE')
