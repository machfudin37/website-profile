...
@section('konten')
    <main class="main users chart-page" id="skip-target">
        <div class="container">
            <h2 class="main-title">Tambah Pengumuman</h2>
                ...
                <div class="col-lg-9">
                    <div class="users-table table-wrapper1">
                        <article class="sign-up">
                            <form class="sign-up-form form" action="{{ route('admin.pengumuman.kirim') }}" method="post"
                                style="width: 1100px;" enctype="multipart/form-data">
                                @csrf
                                <label class="form-label-wrapper">
                                    <p class="form-label">Isi</p>
                                    <textarea class="form-input" name="isi" id="isi" cols="30" rows="10" style="height: 100px"
                                        placeholder="Masukan Isi" required></textarea>
                                </label>
                                <label class="form-label-wrapper">
