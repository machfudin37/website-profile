...
@section('konten')
    <main class="main users chart-page" id="skip-target">
        <div class="container">
            <h2 class="main-title">Tambah Berita Kegiatan Video</h2>
                ...
                <div class="col-lg-9">
                    <div class="users-table table-wrapper1">
                        <article class="sign-up">
                            <form class="sign-up-form form" action="{{ route('admin.video.kirim') }}" method="post"
                                ...
                                <label class="form-label-wrapper">
                                    ...
                                    <textarea class="form-input" name="video" id="video" cols="30" rows="10" style="height: 100px"
                                        placeholder="Masukan Link Video Youtube" required></textarea>
                                </label>
                                <label class="form-label-wrapper">
