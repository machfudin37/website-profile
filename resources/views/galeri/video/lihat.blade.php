    ...
    <section class="services section section__title" id="services2">
        <div class="card-container">
            <div class="card" style="width: 700px; height:auto;">
                <div class="card video-artikel" style="width: 700px;height:280px; margin-left:0; margin-top:0;">
                    {!! $video->video !!}
                </div>
                <div class="card-content">
                    <h1 class="judul-artikel">{{ $video->judul }}</h1>
                    <p class="bagian"><i
                            class="fa-solid fa-user"></i>&nbsp;&nbsp;{{ $video->bagian }}&nbsp;&nbsp;&nbsp;&nbsp;<i
                            class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp;{{ date('d-m-Y', strtotime($video->created_at)) }}
                    </p>
