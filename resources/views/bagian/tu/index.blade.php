        ...
        <div class="card-container">
            <div class="card" style="width: 700px; height:auto;">
                <div class=" card gambar" style="width: 700px;height:280px; margin-left:0; margin-top:0;">
                    <img src="{{ asset('assets/tatausaha/foto/' . $bagian->foto) }}" alt="foto"
                ...
                <div class="card" style="width: 450px; height:auto;">
                    ...
                    <div id="1" class="collapse in show" role="tabpanel" aria-labelledby="informasi">
                        <div class="card-body" style="text-align:start; margin-left:15px;">
                            <p class="card-header" role="tab" id="keuangan">
                                <button class="nav__link" style="font-size:18px;" data-toggle="collapse"
                                    data-parent="#accordion" data-target="#menu1" aria-expanded="true"
                                    aria-controls="menu1">Keuangan
                                </button>
                            </p>

                            <div id="menu1" class="collapse show" role="tabpanel" aria-labelledby="keuangan">
                                <div class="card-body">
                                    @foreach ($keuangan as $k)
                                        <p class="isi">
                                            <a href="{{ route('admin.keuangan.display', ['id' => $k->id]) }}"
                                                style="color: var(--text-color);">{{ $k->sub_menu }}</a>
                                        </p>
                                    @endforeach
                                </div>
                            </div>
                            <p class="card-header" role="tab" id="kepegawaian">
                                <button class="nav__link" style="font-size:18px;" data-toggle="collapse"
                                    data-parent="#accordion" data-target="#menu2" aria-expanded="true"
                                    aria-controls="menu2">Kepegawaian
                                </button>
                            </p>

                            <div id="menu2" class="collapse show" role="tabpanel" aria-labelledby="kepegawaian">
                                <div class="card-body">
                                    @foreach ($kepegawaian as $k)
                                        <p class="isi">
                                            <a href="{{ route('admin.kepegawaian.display', ['id' => $k->id]) }}"
                                                style="color: var(--text-color);">{{ $k->sub_menu }}</a>
                                        </p>
                                    @endforeach
                                </div>
                            ...
                            <p class="card-header" role="tab" id="kepegawaian">
                                <a href="#" class="nav__link"
                                    style="font-size:16px; font-weight: normal;">E-Persediaan Barang
                                </a>
                            </p>
                        </div>
                    </div>
