        ...
        <div class="card-container">
            <div class="card" style="width: 700px; height:auto;">
                <div class=" card gambar" style="width: 700px;height:280px; margin-left:0; margin-top:0;">
                    <img src="{{ asset('assets/komunikasidaninformasipublik/foto/' . $bagian->foto) }}" alt="foto"
                    ...
                    <div id="1" class="collapse in show" role="tabpanel" aria-labelledby="informasi">
                        <div class="card-body" style="text-align:start; margin-left:15px;">
                            <p class="card-header" role="tab" id="kepegawaian">
                                <a href="https://www.youtube.com/channel/UCv0IRxKa-qKrgUhbgMl9uqw" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">Youtube
                                    Channel
                                </a>
                            </p>
                            <p class="card-header" role="tab" id="kepegawaian">
                                <a href="{{ route('organisasi.kewartawanan.lihat', ['id' => 1]) }}" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">ORGANISASI
                                    KEWARTAWANAN
                                </a>
                            </p>
                            <p class="card-header" role="tab" id="kepegawaian">
                                <a href="{{ route('data.wartawan.lihat') }}" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">DATA
                                    JURNALIS/WARTAWAN JAKARTA TIMUR
                                </a>
                            </p>
                        </div>
                    </div>
