        ...
        <div class="card-container">
            <div class="card" style="width: 700px; height:auto;">
                <div class=" card gambar" style="width: 700px;height:280px; margin-left:0; margin-top:0;">
                    <img src="{{ asset('assets/jaringankomunikasidata/foto/' . $bagian->foto) }}" alt="foto"
                ...
                <div class="card" style="width: 450px; height:auto;">
                    ...
                    <div id="1" class="collapse in show" role="tabpanel" aria-labelledby="informasi">
                        <div class="card-body" style="text-align:start; margin-left:15px;">
                            <p class="card-header" role="tab" id="sodtiti">
                                <a href="{{ route('jkd.display.sodtiti', ['id' => 1]) }}" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">STANDAR
                                    OPERASIONAL DUKUNGAN TEKNIS INFRASTRUKTUR TEKNOLOGI INFORMASI
                                </a>
                            </p>
                            <p class="card-header" role="tab" id="dldkrrt">
                                <a href="#" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">DAFTAR LAPORAN
                                    DAN KONDISI RADIO RIG TRUNKING
                                </a>
                            </p>
                            <p class="card-header" role="tab" id="dc">
                                <a href="{{ route('jkd.display.daftarcctv', ['id' => 1]) }}" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">DAFTAR CCTV
                                </a>
                            </p>
                            <p class="card-header" role="tab" id="dc">
                                <a href="#" class="nav__link"
                                    style="font-size:16px; font-weight: normal; text-transform:uppercase;">GEOGRAPHY
